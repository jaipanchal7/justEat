<%@ page import ="com.justeat.model.*"%>
<%@ page import="com.justeat.utility.*"%>
<%@ page import="com.justeat.dao.*"%>
...
<div class="container-fluid">
  <img src="resources/images/Just_Eat_Takeaway.com_icon_logo.svg.png" width="40" height="35" class="d-inline-block align-top" alt="">
  <a class="navbar-brand" href="/"><h2 class="logo">justEat</h2></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    %>
                 <li class="nav-item active">
                    <a class="nav-link" href="admindashboard"><b class="admin-nav">Admin Page</b> <span class="sr-only">(current)</span></a>
                 </li>
    <%
        	 }
    %>
      ...
      <li class="nav-item active text-color ml-2" data-toggle="modal" data-target=".aboutusmodal">
          <div class="nav-link" ><b class="about-us">About us</b></div>
      </li>
      
      <li class="nav-item active text-color ml-2" data-toggle="modal" data-target=".contactusmodal">
          <div class="nav-link" ><b class="contact-us">Contact us</b></div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
              ...
              %>
                     ...
                     <li class="nav-item active text-color">
                        <a class="nav-link" href="myorder"><b class="myorder">My Orders</b></a>
                     </li>
             ...
             <li class="nav-item active text-color" data-toggle="modal" data-target=".logout-modal">
               <a class="nav-link" href="#" ><b class="logout">Logout</b></a>
             </li> 
    ...
    %>
      <ul class="navbar-nav ml-auto text-color">
       <li class="nav-item active">
        <div class="nav-link" data-toggle="modal" data-target=".forgetpasswordmodal"><b class="forget-pass">Forget password</b></div>
      </li> 
    
      <li class="nav-item active text-color">
        <a class="nav-link" href="userregister"><b class="user-reg">Register</b></a>
      </li>  
      
      <li class="nav-item text-color active">
        <a class="nav-link" href="userlogin"><b class="login">Login</b></a>
      </li>    
    </ul>
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                ...
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">jaipanchal100@gmail.com
            </b>
        </p>
        </div>
      </div>
